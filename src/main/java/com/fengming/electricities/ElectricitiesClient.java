...
@Mod(value = Electricities.MODID, dist = Dist.CLIENT)
// You can use EventBusSubscriber to automatically register all static methods in the class annotated with @SubscribeEvent
@EventBusSubscriber(modid = Electricities.MODID, value = Dist.CLIENT)
public class ElectricitiesClient {
    public ElectricitiesClient(ModContainer container) {
