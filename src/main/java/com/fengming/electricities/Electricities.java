...
@Mod(Electricities.MODID)
public class Electricities {
    // Define mod id in a common place for everything to reference
    public static final String MODID = "electricities";
    ...
    public Electricities(IEventBus modEventBus, ModContainer modContainer) {
        ...
        ModCreateModeTabs.CREATIVE_MODE_TABS.register(modEventBus);
